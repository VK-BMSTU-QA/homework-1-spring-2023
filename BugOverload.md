...
1. При нажатии на логотип происходит переход на главную страницу сайта
2. При нажатии на кнопки "Популярное" и "Премьеры" происходит переход на соответствующие страницы
3. Если пользователь авторизован, при нажатии на кнопку "Коллекции" происходит переход на страницу с коллекциями пользователя
4. Если пользователь авторизован, в конце панели навигации будет отображаться область профиля пользователя
   ![user-profile-area](https://user-images.githubusercontent.com/30394005/222218871-1bc0ba7b-74ce-4c18-a5ee-4a19a5d68663.png)
5. При наведении на область профиля, должно возникать выпадающее меню
   ![user-profile-buttons](https://user-images.githubusercontent.com/30394005/222219263-f52af34c-4ad4-423e-97bf-d755414c676c.png)
6. При нажатии на кнопки "Профиль", "Коллекции", "Премьеры" в области профиля, должен происходить переход на соответствующие страницы
7. При нажатии на кнопку "Выйти" в области профиля, должен происходить выход из учетной записи и область профиля заменяется на кнопку "Войти"

_Негативные кейсы:_
1. Если пользователь неавторизован, при нажатии на кнопку "Коллекции" возникает модальное окно авторизации
...
**`BUG`** если экран < 1000px, уведомления обрезаются, уходя за границу экрана
...
3. Каждое уведомление должно содержать в себе рейтинг фильма/сериала, название, дату выхода, кнопку "купить билет" и кнопку закрытия
4. При переходе на другую страницу, все уведомления пропадают

_Негативные кейсы:_
1. Если пользователь неавторизован, то он не увидит уведомлений
2. Если авторизованный пользователь обновляет страницу, то уведомления больше не приходят до 00:00 по МСК.
