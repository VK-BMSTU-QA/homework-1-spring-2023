...
2. Надписи соответсвтуют нужным полям
...
4. Если зажать левую кнопку мыши в пределах окна, и отпустить за его пределами, оно закроется_**`BUG`**_
...
4. Текст ошибки имеет достаточный для чтения размер на всех экранах_**`BUG`**_
...
2. Фото профиля загружается на сервер, обновлясь на клиенте_**`BUG`**_
...
6. После публикации рецензии_**`BUG`**_, общее количество рецензий в профиле увеличилось на 1_**`BUG`**_
