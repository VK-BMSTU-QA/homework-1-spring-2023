...
1. Все тексты не содержат орфографических ошибок
2. Отображается как минимум _локализованное имя_, _дата рождения_, _аватар пользователя_, _число фильмов_, _стандартный аватар_
3. В самом общем случае дополнительно отображается _имя_, _дата смерти_, _картинки персоны_ и вместо _стандартного аватара_ _оригинальный аватар_
4. Отображаются "Лучшие фильмы"
...
1. Все тексты не содержат орфографических ошибок
2. Отображается _название коллекции_, _описание коллекции_
3. Отображаются фильмы в коллекции
4. При нажатии на кнопку "Сети" копируется ссылка на текущую коллекцию

_Негативные кейсы_:

1. Если перейти по ссылке на приватную коллекцию  _**`BUG`**_: будет черный экран в блоке коллекций
2. _**`BUG`**_: Можно скопировать ссылку на приватную коллекцию 
...
2. При наведении на коллекцию показывает число фильмов в ней
3. Отображаются фильмы в коллекции
4. При нажатии на кнопку "Сети" копируется ссылка на текущую коллекцию
