...
2. Дата регистрации указана в формате дд.мм.гггг
3. Если оценок или рецензий нет, то в поле оценки надпись: нет оценок, а в графе рецензии: нет рецензий
4. После того, как оценили фильм, в профиле увеличилось количество оценок на 1
5. После публикации рецензии_**`BUG`**_, общее количество рецензий в профиле увеличилось на 1_**`BUG`**_
6. При удалении оценки, общее количество оценок в профиле уменьшится на 1
7. При ширине экрана < 526px основная информация перемещается под профиль
8. При наведение на кнопку "Выбрать файл", её задний фон осветляется
