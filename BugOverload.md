...
* [↓](#cтраница-фильма) Страница фильма (оценка, рецензия, информация, трейлер)
...
#### Оценка фильма
!!(green)Положительные кейсы!!
1. Авторизаванные пользователи могут поставить оценку от 1 до 10 включительно.
...
12. В зависимости от того, открыта страница фильма или сериала должна соответствовать надпить над блоком. _"Как вам фильм?"_, если фильм, _"Как вам сериал?"_, если открыт сериал.
...
1. Есть выделение желтымм неактивного блока при наведении
...
3. Под название блока "В главных ролях" отображается число актеров, совпадающее с числом нижеперечисленных персон.
...
2. Слайдер позволяет прокручивать фильма (Аналогично Главной странице [↓](.ссылка.))
...
1. При установлении курсора в поле ввода иконка лупы менят свой цвет на жёлтый. Обратно менят на белый при потере фокуса.
